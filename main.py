...
def one_book(url) -> None:
    book = BookInfo(url)
    with open('document.csv', 'a') as fd:
        fd.write('{},{},{},{},{},{},{},{},{},{},{},{}\n'.format(book.get_book_title(), book.get_book_authors(),
                                                                book.get_description(), book.get_number_pages(), 
                                                                book.get_publisher(), book.get_isbn(), book.get_isbn13(),
                                                                book.get_rating(), book.get_rating(), book.get_last_date(), 
                                                                book.get_first_date(), book.get_author_url()))
...
if __name__ == "__main__":
    ...
    with open('document.csv', "w") as fd:
        fd.write(
            'title,authors,description,number_pages,publisher,isbn,isbn13,rating,last_date,first_date,author_url,\n')
